package com.qingshan.qsbi.utils.text;
...
public class CharacterRecognition {
    ...
    //控制台获取以下信息
    private String appid = XhConstant.appid;
    private String apiSecret = XhConstant.apiSecret;
    private String apiKey = XhConstant.apiKey;
    //图片存放位置
