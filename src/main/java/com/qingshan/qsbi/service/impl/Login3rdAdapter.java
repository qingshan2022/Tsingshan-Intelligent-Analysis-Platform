...
import com.qingshan.qsbi.service.Login3rdTarget;
...
public class Login3rdAdapter extends UserServiceImpl implements Login3rdTarget {
    ...
    @Override
    public BaseResponse loginByGitee(String state, String code) throws ParseException {
    ...
    @Override
    public BaseResponse loginByGithub(String state, String code) throws ParseException {
    ...
    private BaseResponse autoRegister3rdAndLogin(String email) throws ParseException {
