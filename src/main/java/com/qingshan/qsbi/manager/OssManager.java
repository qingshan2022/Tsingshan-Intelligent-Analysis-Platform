package com.qingshan.qsbi.manager;


import com.aliyun.oss.OSSClient;
import com.aliyun.oss.model.ObjectMetadata;
import com.aliyun.oss.model.PutObjectResult;
import com.qingshan.qsbi.config.OSSConfig;
...
public class OssManager {
    ...
    public FileUploadResult uploadImage(MultipartFile uploadFile) {
        ...
        try {
            ...
            com.aliyun.oss.model.ObjectMetadata metadata = new ObjectMetadata();
    ...
    private String getFilePath(String sourceFileName) {
        ...
        return "QSBI/" + "user-" + userId + RandomUtils.nextInt(100, 9999) + "."
